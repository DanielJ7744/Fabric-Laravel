...
use App\Models\Alerting\AlertScheduler;
...
return [
    ...
    */
    'resources' => [
        ...
        'service-logs' => ServiceLog::class,
        'companies' => Company::class,
        'systems' => System::class,
        'filter-templates' => FilterTemplate::class,
        'integrations' => Integration::class,
        'users' => User::class,
        'entities' => Entity::class,
        'report-sync-results' => ReportSyncResult::class,
        'report-sync-filter-options' => ReportSyncFilterOption::class,
        'alert-recipients' => AlertRecipients::class,
        'alert-groups' => AlertGroups::class,
        'alert-scheduler' => AlertScheduler::class,
        'alert-configs' => AlertConfigs::class,
        'alert-manager' => AlertManager::class,
        'alert-service-recipients' => AlertServiceRecipients::class,
    ],
