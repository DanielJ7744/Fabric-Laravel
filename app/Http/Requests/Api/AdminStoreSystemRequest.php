...
use App\Rules\Systems\SystemAuthDriver;
use App\Rules\SystemWebsite;
use Illuminate\Foundation\Http\FormRequest;

class AdminStoreSystemRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'system_type_id'                    => ['required', 'integer', 'exists:system_types,id'],
            'name'                              => ['required', 'string', 'min:3', 'max:128', new Name(), new SystemAuthDriver(), 'unique:systems,name'],
            'factory_name'                      => ['required', 'string', 'min:3', 'max:255', new Name()],
