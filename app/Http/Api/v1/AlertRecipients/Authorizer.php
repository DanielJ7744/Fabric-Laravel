...
class Authorizer extends AbstractAuthorizer
{
    ...
    {
        $this->can('search alert-recipients', $type);
    }
    ...
    {
        $this->can('create alert-recipients', $type);
    }
    ...
    {
        $this->can('read alert-recipients', $record);
    }
    ...
    {
        $this->can('update alert-recipients', $record);
    }
    ...
    {
        $this->can('delete alert-recipients', $record);
    }
}
