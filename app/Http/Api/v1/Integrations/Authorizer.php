...
class Authorizer extends AbstractAuthorizer
{
    ...
    {
        $this->can('search integrations', $type);
    }
    ...
    {
        $this->can('create integrations', $type);
    }
    ...
    {
        $this->can('read integrations', $record);
    }
    ...
    {
        $this->can('update integrations', $record);
    }
    ...
    {
        $this->can('delete integrations', $record);
    }
}
