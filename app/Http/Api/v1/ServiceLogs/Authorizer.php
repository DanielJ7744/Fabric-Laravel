...
class Authorizer extends AbstractAuthorizer
{
    ...
    {
        $this->can('read service-logs', $type);
    }
    ...
    {
        $this->can('create service-logs', $type);
    }
    ...
    {
        $this->can('read service-logs', $record);
    }
    ...
    {
        $this->can('update service-logs', $record);
    }
    ...
    {
        $this->can('delete service-logs', $record);
    }
}
