...
class Authorizer extends AbstractAuthorizer
{
    ...
    {
        $this->can('search report-sync-filter-options', $type);
    }
    ...
    {
        $this->can('create report-sync-filter-options', $type);
    }
    ...
    {
        $this->can('read report-sync-filter-options', $record);
    }
    ...
    {
        $this->can('update report-sync-filter-options', $record);
    }
    ...
    {
        $this->can('delete report-sync-filter-options', $record);
    }
}
