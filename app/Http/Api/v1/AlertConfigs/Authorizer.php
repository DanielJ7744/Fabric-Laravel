...
class Authorizer extends AbstractAuthorizer
{
    ...
    {
        $this->can('search alert-configs', $type);
    }
    ...
    {
        $this->can('create alert-configs', $type);
    }
    ...
    {
        $this->can('read alert-configs', $record);
    }
    ...
    {
        $this->can('update alert-configs', $record);
    }
    ...
    {
        $this->can('delete alert-configs', $record);
    }
}
