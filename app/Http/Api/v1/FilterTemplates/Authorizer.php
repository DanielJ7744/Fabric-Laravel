...
class Authorizer extends AbstractAuthorizer
{
    ...
    {
        $this->can('search filter-templates', $type);
    }
    ...
    {
        $this->can('create filter-templates', $type);
    }
    ...
    {
        $this->can('read filter-templates', $record);
    }
    ...
    {
        $this->can('update filter-templates', $record);
    }
    ...
    {
        $this->can('delete filter-templates', $record);
    }
}
