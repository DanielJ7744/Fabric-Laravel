 ...
 * @group users
 */
class IntegrationUserControllerTest extends LaravelTestCase
{
    use RefreshDatabase;
    ...
    public function test_user_with_permission_can_create_integration_users(): void
    {
        ...
        $this
            ...
            ->postJson(route('api.v2.integrations.users.store', $this->integration), $attributes)
            ->assertOk()
    ...
    public function test_user_with_permission_can_delete_an_integration_user(): void
    {
        $this
            ->passportAs($this->withPermissions)
            ->deleteJson(route('api.v2.integrations.users.destroy', [$this->integration, $this->attachedUser]))
            ->assertOk()
