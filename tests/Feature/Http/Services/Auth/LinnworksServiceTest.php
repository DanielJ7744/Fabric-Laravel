 ...
 * @group connectors
 */
class LinnworksServiceTest extends LaravelTestCase
{
    use RefreshDatabase;
    ...
    public function setup(): void
    {
        ...
        $this->system = factory(System::class)->create(['factory_name' => 'Linnworks']);
    ...
    public function test_authenticate_method(): void
    {
        ...
        $mock = $this->partialMock(LinnworksService::class, fn ($mock) => $mock
