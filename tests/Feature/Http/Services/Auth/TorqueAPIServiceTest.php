 ...
 * @group connectors
 */
class TorqueAPIServiceTest extends LaravelTestCase
{
    use RefreshDatabase;
    ...
    public function setup(): void
    {
        ...
        $this->system = factory(System::class)->create(['factory_name' => 'TorqueAPI']);
    ...
    public function test_authenticate_method(): void
    {
        ...
        $mock = $this->partialMock(TorqueAPIService::class, fn ($mock) => $mock
