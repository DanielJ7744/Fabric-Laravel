 ...
 * @group connectors
 */
class PrimaServiceTest extends LaravelTestCase
{
    use RefreshDatabase;
    ...
    public function setup(): void
    {
        ...
        $this->system = factory(System::class)->create(['factory_name' => 'Prima']);
    ...
    public function test_credentials_validation(): void
    {
        ...
        $this
            ...
            ->assertJsonValidationErrors(['credentials' => implode(' ', [
                'The prima soap url field is required.',
            ])]);

        $data['credentials'] = ['prima_soap_url' => 'test.test.com/test'];
        ...
        $this
            ...
            ->assertStatus(422)
            ->assertJsonValidationErrors(['credentials' => implode(' ', [
                'The prima soap url format is invalid.',
            ])]);
    }
    ...
    {
        $credentials = [
            'prima_soap_url' => 'test.test.com:8443/test/test',
            'connector_name' => 'test',
            'timezone' => 'UTC',
            'date_format' => 'd/m/Y',
        ...
        $mock = $this->partialMock(PrimaService::class, fn ($mock) => $mock
