 ...
 * @group connectors
 */
class PeoplevoxServiceTest extends LaravelTestCase
{
    use RefreshDatabase;
    ...
    public function setup(): void
    {
        ...
        $this->system = factory(System::class)->create(['factory_name' => 'Peoplevox']);
    ...
    public function test_authenticate_method(): void
    {
        ...
        $mock = $this->partialMock(PeoplevoxService::class, fn ($mock) => $mock
