 ...
 * @group connectors
 */
class MagentoTwoServiceTest extends LaravelTestCase
{
    use RefreshDatabase;
    ...
    public function setup(): void
    {
        ...
        $this->system = factory(System::class)->create(['factory_name' => 'Magentotwo']);
    ...
    public function test_authenticate_method(): void
    {
        ...
        $mock = $this->partialMock(MagentotwoService::class, fn ($mock) => $mock
