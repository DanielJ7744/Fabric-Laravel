 ...
 * @group connectors
 */
class NetSuiteRestServiceTest extends LaravelTestCase
{
    use RefreshDatabase;
    ...
    public function setup(): void
    {
        ...
        $this->system = factory(System::class)->create(['factory_name' => 'NetSuiteRest']);
    ...
    public function test_request_access_token_method(): void
    {
        ...
        $mock = $this->partialMock(NetSuiteRestService::class, fn ($mock) => $mock
